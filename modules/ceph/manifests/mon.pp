...
if [ ! -d \$mon_data ] ; then
# mkdir -p \$mon_data
  mkdir -p \$mon_data && chown -Rh ceph: \$mon_data
...
#    touch \$mon_data/done \$mon_data/${init} \$mon_data/keyring
    touch \$mon_data/done \$mon_data/${init} \$mon_data/keyring \$mon_data/store.db && chown -Rh ceph: \$mon_data/done \$mon_data/${init} \$mon_data/keyring \$mon_data/store.db
  else
    rm -fr \$mon_data
  fi
fi
