...
#
# [*wsrep_node_address*]
#   To set if different from $ipaddress ip   
#
# [*binlog_format*]
#   The binlog format
#
...
class percona(
  ...
  $wsrep_cluster_name = 'clusterPercona',
  ...
  if $master {
    contain percona::preinstall
    contain percona::install
    contain percona::configure
    contain percona::master
